...
#define OPAQUE 0xffU
static const unsigned int baralpha    = 0xd9;  /* bar island background opacity */
...
static const Key keys[] = {
	...
	{ MODKEY,			XK_Insert,     spawn,                  SHCMD("xdotool type $(grep -v '^#' ~/.local/share/rice/snippets | dmenu -i -l 50 | cut -d' ' -f1)") },
